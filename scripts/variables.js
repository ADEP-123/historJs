class Variables {
    constructor(flipCards, flipUnits, startButton, divInicio, transContaniner, zonaConteo, transCohete, zonaHistoria, beepSound,coheteSound) {
...
const variables = new Variables(
    ...
    document.getElementById('audDespegue'));
